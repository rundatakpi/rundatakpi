...
public class RemoteExecuteCommand {
	...
	public static void main(String[] args) {
		...
		RemoteExecuteCommand rec = new RemoteExecuteCommand("xx.xx.xx.xx", "root", "root");
		// 执行命令
		try {
			if (rec.login()) {
				...
				// TODO:多条命令
				session.execCommand(
						"cd /home/ubuntu/Desktop/music_rec/user_sim;echo \"123\" | sudo  -S ./caculate_tim_sim.sh similar");// 执行命令
