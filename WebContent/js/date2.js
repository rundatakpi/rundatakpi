...
function timeMethod(){
	...
	$("#startTime,#endTime,.startTime,.endTime").click(function(){
		
		if (!$(this).hasClass('disabled')) {
			WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'});
		}
	});
	$("#startTime2,#endTime2,.startTime,.endTime").click(function(){
		if (!$(this).hasClass('disabled')) {
			WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'});
		}
	});
	$("#startTime3,#endTime3,.startTime,.endTime").click(function(){
		if (!$(this).hasClass('disabled')) {
			WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'});
		}
	});
...
function getTimeByDay(day,startId,endId){
	...
	/*$("#"+startTime).addClass('disabled').prop('readonly',true);
	$("#"+endTime).addClass('disabled').prop('readonly',true);*/
	...
	if(day!=null && day!="" && day!=-1){
		...
		// �Զ���ʱ��
		/*$("#"+startTime).val("").removeClass('disabled').prop('readonly',false);
		$("#"+endTime).val("").removeClass('disabled').prop('readonly',false);*/
		$("#"+startTime).val("").removeProp('disabled');
		$("#"+endTime).val("").removeProp('disabled');
	}
