...
function showFieldDetail(_this,num){
	...
	layer.open({
		  ...
		  shade: 0.8,
		  area: ['800px', '600px'],
		  content: rootPath+'/kpi/estimate/log/bLogDetail.html?dataSourceCode='+dataSourceCode+"&bProtocolCode="+bProtocolCode+'&colName='+colName//iframe的url
	});
...
function showProtocolDetail(_this){
	...
	window.location.href = rootPath+'/kpi/estimate/log/sProtocolLog.html?dataSourceCode='+dataSourceCode+"&bProtocolCode="+bProtocolCode;
}
